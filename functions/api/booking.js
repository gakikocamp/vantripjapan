  ...
  const CUSTOMER_MAIL_I18N = {
    en: {
      ...
      body: (ins, wa, cal) => [
        ...
        `  • Return:    ${ret}`,
        `  • Insurance: ${ins}`, ``,
        `🚗 One thing to check before pick-up: if your licence is German, Swiss,`,
        `French, Belgian, Monegasque or Taiwanese, an International Driving Permit`,
        `is NOT accepted in Japan — you'll need an official Japanese translation`,
        `of your licence to drive. Our sister service JDLTC arranges it online,`,
        `delivered by email as a PDF:`,
        `  https://drive-japan-license.com/?utm_source=vtj&utm_medium=email&utm_campaign=booking`, ``,
        ...(cal ? [
    ...
    fr: {
      ...
      body: (ins, wa, cal) => [
        ...
        `  • Retour : ${ret}`,
        `  • Assurance : ${ins}`, ``,
        `🚗 À vérifier avant la prise en charge : avec un permis français, belge,`,
        `suisse ou monégasque, le permis de conduire international n'est PAS`,
        `accepté au Japon — une traduction japonaise officielle est nécessaire`,
        `pour conduire. Notre service partenaire JDLTC s'en occupe en ligne,`,
        `envoyée par e-mail en PDF :`,
        `  https://drive-japan-license.com/fr/?utm_source=vtj&utm_medium=email&utm_campaign=booking`, ``,
        ...(cal ? [
    ...
    de: {
      ...
      body: (ins, wa, cal) => [
        ...
        `  • Rückgabe: ${ret}`,
        `  • Versicherung: ${ins}`, ``,
        `🚗 Bitte vor der Abholung prüfen: Mit deutschem, schweizer, französischem`,
        `oder belgischem Führerschein wird der Internationale Führerschein in Japan`,
        `NICHT anerkannt — zum Fahren brauchen Sie eine offizielle japanische`,
        `Übersetzung Ihres Führerscheins. Unser Partnerservice JDLTC erledigt das`,
        `online, Zustellung als PDF per E-Mail:`,
        `  https://drive-japan-license.com/de/?utm_source=vtj&utm_medium=email&utm_campaign=booking`, ``,
        ...(cal ? [
    ...
    zh: {
      ...
      body: (ins, wa, cal) => [
        ...
        `  • 還車：${ret}`,
        `  • 保險：${ins}`, ``,
        `🚗 取車前請確認：持台灣駕照者，國際駕照（IDP）在日本不被承認 —`,
        `開車需要駕照的日文官方譯本。我們的姊妹服務JDLTC可全程線上辦理，`,
        `PDF電子郵件寄送：`,
        `  https://drive-japan-license.com/zh-TW/?utm_source=vtj&utm_medium=email&utm_campaign=booking`, ``,
        ...(cal ? [
          `📅 加入日曆（暫定日期，待確認後為準）：`,
          `  ${cal.gcalUrl}`,
  ...
  const M = {
    en: {
      ...
      body: [
        ...
        ``,
        `🚨 If you have an accident (even a small scrape):`,
        `  1. Call the police on 110 from the scene and wait until they have recorded it.`,
        `  2. Message Karen on WhatsApp right away: ${WA}`,
        `  Without a police report, the deductible limits and the Zero-Risk cover do not apply. Full terms: https://vantripjapan.jp/rent/terms/`,
        ``,
    ...
    fr: {
      ...
      body: [
        ...
        ``,
        `🚨 En cas d'accident (même une simple éraflure) :`,
        `  1. Appelez la police (110) depuis les lieux et attendez qu'elle ait constaté l'accident.`,
        `  2. Prévenez Karen sur WhatsApp sans attendre : ${WA}`,
        `  Sans déclaration à la police, les plafonds de franchise et la Couverture Sans Risque ne s'appliquent pas. Conditions complètes : https://vantripjapan.jp/rent/terms/`,
        ``,
    ...
    de: {
      ...
      body: [
        ...
        ``,
        `🚨 Bei einem Unfall (auch nur ein kleiner Kratzer):`,
        `  1. Rufen Sie vor Ort die Polizei (110) und warten Sie, bis der Unfall aufgenommen ist.`,
        `  2. Schreiben Sie Karen sofort per WhatsApp: ${WA}`,
        `  Ohne Polizeibericht gelten weder die Obergrenzen der Selbstbeteiligung noch der Null-Risiko-Schutz. Mietbedingungen: https://vantripjapan.jp/rent/terms/`,
        ``,
    ...
    zh: {
      ...
      body: [
        ...
        ``,
        `🚨 發生事故時（即使只是輕微擦撞）：`,
        `  1. 在現場撥打 110 報警，等待警察完成紀錄。`,
        `  2. 立即透過 WhatsApp 聯絡 Karen：${WA}`,
        `  沒有報警紀錄時，自負額上限與零風險方案皆不適用。完整條款：https://vantripjapan.jp/rent/terms/`,
        ``,
    ...
    he: {
      ...
      body: [
        ...
        ``,
        `🚨 במקרה של תאונה (גם שריטה קלה):`,
        `  1. התקשרו למשטרה (110) מזירת התאונה והמתינו עד שהשוטר יתעד אותה.`,
        `  2. עדכנו את קארן מיד בוואטסאפ: ${WA}`,
        `  ללא דיווח למשטרה, תקרת ההשתתפות העצמית והכיסוי ללא סיכון אינם חלים. התנאים המלאים: https://vantripjapan.jp/rent/terms/`,
        ``,
